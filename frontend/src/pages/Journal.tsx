        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">Document your travel stories, memories, and track expenses</p>
            </div>
          ...
          <div className="flex space-x-4 border-b border-gray-200">
            <button
              ...
              className={`px-4 py-2 font-semibold transition-colors ${activeTab === 'journal'
            ...
            <button
              ...
              className={`px-4 py-2 font-semibold transition-colors ${activeTab === 'expenses'
                  ? 'text-blue-600 border-b-2 border-blue-600'
                  : 'text-gray-600 hover:text-gray-900'
                }`}
            >
              ...
              <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${selectedTrip === 'all'
                  ...
                  {trips.map((trip) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium transition-all ${selectedTrip === trip.name
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${selectedTrip === 'unassigned'
                  ...
                  <div key={entry.id} className="card border-l-4 border-blue-500 shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                      ...
                      <button
                        ...
                        className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all ${entry.enhanced
              ...
              <div className="mb-6 p-4 bg-white border border-blue-200 rounded-lg">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${selectedExpenseDate === ''
                        ? 'bg-blue-600 text-white shadow-md'
                  ...
                  {getUniqueDates().map((date) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium transition-all ${selectedExpenseDate === date
                          ? 'bg-blue-600 text-white shadow-md'
                          : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                        }`}
                    >
              ...
              <div className="bg-black bg-opacity-40 px-8 py-4">
                ...
                <div className="flex items-center justify-center space-x-3">
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all ${currentEntryIndex === 0
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all ${currentEntryIndex === getFilteredEntries().length - 1
                        ? 'bg-gray-600 text-gray-400 cursor-not-allowed'
                        : 'bg-white bg-opacity-20 hover:bg-opacity-30 text-white'
                      }`}
                  >
